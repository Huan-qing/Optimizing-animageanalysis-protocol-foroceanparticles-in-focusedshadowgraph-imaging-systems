...
tic
clear; close all; clc
path='/home/hhuan006/RedSea_analysis/comb/SPACE/T=29/sub500/cast-8/';
...
name_col={'Depth(m)','Particle no.','Average particle volume','Total particle volume','Date','Time','second','pressure','temperature', 'salinity', 'fluorescent','oxygen','PAR','potential temperature','density', 'OBS','Beam attenuation','Transmission','voltage'};
...
name_col_2={'second','pressure','temperature', 'salinity', 'fluorescent','oxygen','PAR','potential temperature','density'};
name_col_3={'OBS','Beam attenuation','Transmission','voltage'};
...
if dp_particle(length(dp_particle))-dp_particle(1)+1~=length(dp_particle)
    for i = 1:length(dp_down_bin)-1
        ...
        if dp_particle(i)~=dp_particle(i+1)-1
            ...
            column_ms=[array2table([point_ms,NaN,NaN,NaN,NaN,NaN],'VariableNames',name_col_1),array2table(ctd_down(id_ms_ctd,1:9),'VariableNames',name_col_2),array2table(ctd_down(id_ms_ctd,11:end),'VariableNames',name_col_3)];
